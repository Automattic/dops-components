...
var _demos = [
	{
		...
		id: 'demo-modal',
		js: require( 'raw-loader!./demo-modal.jsxdemo' ),
		requires: {
			'./modal': require( '../modal' )
		}
	},
	{
		...
		js: require( 'raw-loader!./demo-password-box.jsxdemo' ),
		requires: {
	...
	},
	{
		...
		id: 'demo-card',
		js: require( 'raw-loader!./demo-card.jsxdemo' ),
		requires: {
			'./card': require( '../card' )
		}
	},
	{
		...
		id: 'demo-tabs',
		js: require( 'raw-loader!./demo-tabs.jsxdemo' ),
		requires: {
			'./tabs': require( '../tabs' ),
			'./card': require( '../card' )
		}
	},
	{
		...
		id: 'demo-alert-box',
		js: require( 'raw-loader!./demo-alert-box.jsxdemo' ),
		requires: {
	...
	},
	{
		...
		id: 'demo-icons',
		js: require( 'raw-loader!./demo-icon.jsxdemo' ),
		requires: {
			'./icon': require( '../icon' )
		}
	},
	{
		...
		id: 'demo-hover-icons',
		js: require( 'raw-loader!./demo-hover-icon.jsxdemo' ),
		requires: {
	...
	},
	{
		...
		id: 'demo-wizard',
		js: require( 'raw-loader!./demo-wizard.jsxdemo' ),
		requires: {
	...
	},
	{
		...
		id: 'demo-button',
		js: require( 'raw-loader!./demo-button.jsxdemo' ),
		requires: {
	...
	},
	{
		...
		id: 'demo-form',
		js: require( 'raw-loader!./demo-form.jsxdemo' ),
		requires: {
			'./form': require( '../form' )
		}
	},
	{
		...
		id: 'demo-view',
		js: require( 'raw-loader!./demo-view.jsxdemo' ),
		requires: {
			'./view': require( '../view' ),
			'./card': require( '../card' )
		}
	},
	{
		...
		id: 'demo-face',
		js: require( 'raw-loader!./demo-face.jsxdemo' ),
		requires: {
			'./face': require( '../face' )
		}
	},
	{
		...
		id: 'demo-slider',
		js: require( 'raw-loader!./demo-slider.jsxdemo' ),
		requires: {
